...
const CarouselCard = (props) => {
  return (
    <div className=" backdrop backdrop-blur-lg bg-white bg-opacity-5 text-white border border-slate-800 shadow-lg rounded-xl py-24 2xl:px-5 px-3 w-full h-full">
      {props.img && (
