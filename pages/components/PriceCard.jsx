...
const PriceCard = (props) => {
  return (
    ...
    >
      <p className="space-grotesk text-xl font-bold uppercase">$10k</p>
      ...
      <p className="text-5xl font-bold space-grotesk mt-5">$200</p>
      <p className="bullet-point uppercase mt-2 text-sm">5% daily drawn-down</p>
      <p className="bullet-point uppercase mt-2 text-sm">5% daily drawn-down</p>
      <p className="bullet-point uppercase mt-2 text-sm">5% daily drawn-down</p>
      <p className="bullet-point uppercase mt-2 text-sm">5% daily drawn-down</p>
